...
if (isset($_POST['updateVolunteer'])) {
 ...
 if (empty($_POST["a_id"])) {
  ...
  if(isset($_POST['updateVolunteer']) && $flag==1)
  {
    ...
    if (update_volunteer($_POST['v_id'], $data)) {
      echo 'Successfully updated!!';
      //redirect to show_volunteer
      header('Location: ../view/show_volunteer.php?id=' . $_POST["v_id"]);
    }
    else {
